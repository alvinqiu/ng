...
@Component({
  selector: 'app-staffproperty',
  templateUrl: './staffproperty.component.html',
  styleUrls: ['./staffproperty.component.css']
})
export class StaffpropertyComponent implements OnInit {
